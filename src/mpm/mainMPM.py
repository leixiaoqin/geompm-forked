...
class MPM(object):
    ...
    def set_configuration(self, log=True, **kwargs):
        ...
        # LXQ
        self.sims.set_particle_damping(DictIO.GetAlternative(kwargs, "particle_damping", 0.))
    ...
    def print_simulation_info(self):
        ...
        print(("Particle Damping: " + str(self.sims.particle_damping)).ljust(67)) #LXQ
    ...
    def add_boundary_condition(self, boundary=None):
        ...
        if type(boundary) is list or type(boundary) is dict:
            print("boundary: ", type(boundary)) #LXQ
    ...
    def modify_parameters(self, **kwargs):
        if len(kwargs) > 0:
            ...
            # LXQ
            if "particle_damping" in kwargs: self.sims.set_particle_damping(
                DictIO.GetEssential(kwargs, "particle_damping"))
