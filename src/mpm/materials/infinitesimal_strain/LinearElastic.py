...
from src.utils.constants import DELTA, SQRT2
...
class LinearElastic(ConstitutiveModelBase):
    ...
    def wave_speed(self, materialID):
        mat = self.matProps[materialID]  # Cache the material properties lookup
        return ((mat.bulk + 4.0 * mat.shear / 3.0) / mat.density) ** 0.5  # Use ** 0.5 instead of sqrt
