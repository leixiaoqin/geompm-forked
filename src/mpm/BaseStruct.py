...
class ParticleCloud:      # memory usage: 108B
    ...
    unfix_v: vec3u8
    #LXQ
    normal: vec3f #LXQ to store surface normal for each point
    boundary_state: vec3u8 #LXQ to identify the Mps on the boundary
    boundary_force: vec3f  # LXQ to store surface force on the boundary point
...
class Nodes:
    ...
    @ti.func
    def rigid_body_velocity_constraint(self, fix_v, unfix_v):
        print("breakingpoints at rigid_body_velocity_constraint")
        pass
